...
public class BottomBar extends View {
    ...
    public void build() {
        ...
        for (int i = 0; i < itemCount; i++) {
            ...
            try {
                //Fragment fragment = (Fragment) clx.newInstance(new Object[]{context});
                Constructor c1=clx.getDeclaredConstructor(new Class[]{Context.class});
                Fragment fragment = (Fragment) c1.newInstance(new Object[]{context});

...
public class DateUtil {
    public static String formatDate(int arrive_year, int arrive_month, int arrive_day) {
        ...
        return String.format("%04d",arrive_year)+"-"+String.format("%02d",arrive_month)+"-"+String.format("%02d",arrive_day);
    }

    public static String formatTime(int arrive_hour, int arrive_min) {
        return String.format("%02d",arrive_hour)+"-"+String.format("%02d",arrive_min);
    }
